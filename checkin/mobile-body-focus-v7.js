...
@media(max-width:780px){
  ...
  .bodyPanel.arlab-body-focus .bodyPoint{width:22px!important;height:22px!important;border-width:3px!important}
  .arlab-focus-close{position:fixed;right:14px;top:calc(12px + env(safe-area-inset-top));z-index:100001;width:42px;height:42px;border-radius:12px;border:1px solid #d5e1ef;background:#fff;color:#17324f;font-size:24px;line-height:1;display:grid;place-items:center;box-shadow:0 6px 18px rgba(31,56,86,.15);font-weight:700}
